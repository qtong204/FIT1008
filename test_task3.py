...
class TestBattle(unittest.TestCase):
    ...
    def test_set_battle_pokedex_completion(self):
        ...
        # for i in self.trainer1.get_team().original:
        #     print(i.get_poketype())
            
        # # print(self.trainer1.get_team().original)
        # print('\n')

        # for i in self.trainer2.get_team().original:
        #     print(i.get_poketype())
        # print('\n')
        # print(self.trainer1.pokedex)
        # print(self.trainer2.pokedex)
        print(self.trainer2.get_name())
